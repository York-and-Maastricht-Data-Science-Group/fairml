...
class Test(unittest.TestCase):
    ...
    def test_demo_meta_classifier(self):
        ...
        ''' ASSERT '''
        self.assertAlmostEqual(summary2.at[1, 'accuracy'], accuracies[0], places=4)
        self.assertAlmostEqual(summary2.at[1, 'disparate_impact'], disparates[0], places=4)
    ...
    def test_demo_exponentiated_gradient_reduction(self):
        ...
        ''' ASSERT '''
        self.assertAlmostEqual(summary.at[1, 'mean_difference'], metric_scaled_test.mean_difference(), places=4)
        ''' ------ '''
        ...
        ''' ASSERT '''
        self.assertAlmostEqual(summary.at[2, 'accuracy'], lr_acc, places=4)
        ''' ------ '''
        ...
        ''' ASSERT '''
        self.assertAlmostEqual(summary.at[2, 'average_odds_difference'], lr_aod, places=4)
        ''' ------ '''
        ...
        ''' ASSERT '''
        self.assertAlmostEqual(summary.at[3, 'accuracy'], egr_acc, places=2)
        ...
        ''' ASSERT '''
        self.assertAlmostEqual(summary.at[3, 'average_odds_difference'], egr_aod, places=2)
